...
const TabCarousel = () => (
  <div className='app'>
    ...
    <Carousel>
      ...
      <Card title='Software Developer' content='OpenEyes Technologies Inc.' years='Dec 2021 - Till Date' desc="Working on project based on React and Angular with Kendo-UI for Front-end and for back-end PHP - Laravel. Also worked on chrome extension for one of the project. Github repository for code management. And, to deploy the websites used Jenkins." />
