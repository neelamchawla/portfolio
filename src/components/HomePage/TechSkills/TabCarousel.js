...
import Sitecore from "../../img/logo/sitecore.png";
...
const Tag = ({ text, color, darkMode }) => (
  <div
    ...
    style={{
      "--color": color,
      boxShadow: darkMode ? "0px 7px 10px #8492a68c" : "0px 7px 10px #030b168c",
    }}
  >
    <img src={text} height={70} width={70} alt={text} />
  </div>
);
  ...
  <>
    <div className="tag-list">
      {[...new Array(ROWS)].map((_, i) => (
        <InfiniteLoopSlider
          key={i}
          duration={random(DURATION - 5000, DURATION + 37000)}
          reverse={i % 2}
        >
          {shuffle(TAGS)
      ...
      <div
        ...
        style={{
          background: darkMode
            ...
            : "linear-gradient(90deg, white, transparent 30%, transparent 70%, white)",
        }}
      />
    </div>
  </>
