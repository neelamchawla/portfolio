	...
	constructor(props) {
		...
		this.state = {
			items: [
				...
				{ id: 2, item: 'ReactJs, Angular, Vue - (Frameworks)', display: true },
				...
				{ id: 7, item: 'Firebase / GitHub CI/CD / Netlify / Heroku / Gatsby / Jenkins- (3rd party tool for deploying websites)', display: true },
